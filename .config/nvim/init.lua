...
--               "--header-insertion=never", "--inlay-hints=false", "--clang-tidy" },  -- Optionally, specify the clangd binary path
-- 				    filetypes = { "c", "cpp", "objc", "objcpp" },
-- 				      root_dir = lspconfig.util.root_pattern("compile_commands.json", "compile_flags.txt", ".git"), 
-- 				        capabilities = require('cmp_nvim_lsp').default_capabilities(), -- If you're using nvim-cmp for autocompletion
-- 				})
-- 
-- 			-- Bash LSP
